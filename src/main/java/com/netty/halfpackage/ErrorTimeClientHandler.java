 ...
 *
 */
public class ErrorTimeClientHandler extends ChannelInboundHandlerAdapter{

    private static final Logger logger = Logger.getLogger(ErrorTimeClientHandler.class.getName());
    
    private int count;
    
    private byte[] req;
    
    public ErrorTimeClientHandler(){
